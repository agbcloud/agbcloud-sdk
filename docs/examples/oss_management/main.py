...
from agb import AGB
from agb.exceptions import OssError
from agb.oss.oss import Oss
...
def get_oss_credentials():
    ...
    credentials = {
        ...
        "endpoint": os.getenv("OSS_ENDPOINT", "https://oss.example.com"),
        "region": os.getenv("OSS_REGION", "oss-region"),
    }
    return credentials
