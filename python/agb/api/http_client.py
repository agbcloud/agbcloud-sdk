...
from .models.get_cdp_link_request import GetCdpLinkRequest
from .models.get_cdp_link_response import GetCdpLinkResponse
...
from .models.refresh_session_idle_time_request import RefreshSessionIdleTimeRequest
from .models.refresh_session_idle_time_response import RefreshSessionIdleTimeResponse
...
class HTTPClient:
    ...
    def refresh_session_idle_time(
        self, request: RefreshSessionIdleTimeRequest
    ) -> RefreshSessionIdleTimeResponse:
        """HTTP request interface for refreshing session idle time."""
        headers: Dict[str, str] = {}
        params = request.get_params()
        body = request.get_body()
        response_dict = self._make_request(
        ...
        return RefreshSessionIdleTimeResponse.from_http_response(response_dict)

    async def refresh_session_idle_time_async(
        self, request: RefreshSessionIdleTimeRequest
    ) -> RefreshSessionIdleTimeResponse:
        """HTTP request interface for asynchronously refreshing session idle time."""
        headers: Dict[str, str] = {}
        params = request.get_params()
        body = request.get_body()
    ...
    def get_cdp_link(self, request: GetCdpLinkRequest) -> GetCdpLinkResponse:
        """
        HTTP request interface for getting CDP link.

        Args:
            request (GetCdpLinkRequest): Request object for getting CDP link

        Returns:
            GetCdpLinkResponse: Structured response object
        """
        headers: Dict[str, str] = {}
        params = request.get_params()
        ...
        return GetCdpLinkResponse.from_http_response(response_dict)
    ...
    def _make_request(
        ...
        try:
            ...
            try:
                ...
                if isinstance(json_body, dict) and "requestId" in json_body:
                    result["request_id"] = json_body["requestId"]
            except ValueError:
            ...
            response_success: bool = bool(result["success"])
            request_id_val: str = str(result.get("request_id", ""))
                    ...
                    if method.upper() == "GET":
                        async with session.get(url, params=params) as response:
                            ...
                            try:
                                ...
                                json_body = response_dict["json"]
                                if isinstance(json_body, dict) and "requestId" in json_body:
                                    response_dict["request_id"] = json_body["requestId"]
                            except:
                            ...
                            # Prepare response data for logging
                            resp_success: bool = bool(response_dict["success"])
                            req_id: str = str(response_dict.get("request_id", ""))

                            # Extract key fields from response for logging
                            key_fields: Dict[str, Any] = {}
                            json_resp = response_dict.get("json")
                            ...
                            if response_dict.get("json"):
                                ...
                                full_response = str(response_dict["text"])
                        ...
                        if json_data:
                            async with session.post(
                                ...
                                # Prepare response data for logging
                                resp_success = bool(response_dict["success"])
                                req_id = str(response_dict.get("request_id", ""))
