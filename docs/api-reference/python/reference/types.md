...
- `session.computer.screen.capture()`
- `session.computer.screen.get_size()`
- `session.computer.mouse.get_position()`
...
- `session.file.remove()`
- `session.file.write()`
- `session.computer.window.activate()`
- `session.computer.window.close()`
- `session.computer.window.maximize()`
- `session.computer.window.minimize()`
- `session.computer.window.restore()`
- `session.computer.window.resize()`
- `session.computer.window.fullscreen()`
- `session.computer.window.focus_mode()`
- `session.computer.mouse.click()`
- `session.computer.mouse.move()`
- `session.computer.mouse.drag()`
- `session.computer.mouse.scroll()`
- `session.computer.keyboard.type()`
- `session.computer.keyboard.press()`
- `session.computer.keyboard.release()`
