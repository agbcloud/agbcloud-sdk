...
def test_get_session_api():
    ...
    try:
        ...
        get_session_result = agb.get_session(session_id)
        ...
        assert get_session_result.code == "ok" or get_session_result.code == "", f"Expected Code 'ok' or empty, got '{get_session_result.code}'"
        ...
        assert retrieved_session.vpc_resource == get_session_result.data.vpc_resource, "Session.vpc_resource should match GetSessionData.vpc_resource"
        ...
        print("AGB.get() method test passed")
