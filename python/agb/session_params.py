...
class BrowserContext:
    ...
    def __init__(
        ...
        if extension_option:
            ...
            self.extension_context_id: Optional[str] = extension_option.context_id
            self.extension_ids: List[str] = extension_option.extension_ids
            # Auto-generate extension context syncs
            self.extension_context_syncs: Optional[List[ContextSync]] = self._create_extension_context_syncs()
        else:
        ...
        if fingerprint_context:
            self.fingerprint_context_id: Optional[str] = fingerprint_context.fingerprint_context_id
            # Auto-generate fingerprint context sync
            self.fingerprint_context_sync: Optional[ContextSync] = self._create_fingerprint_context_sync()
        else:
    ...
    def _create_fingerprint_context_sync(self) -> Optional[ContextSync]:
        """
...
class CreateSessionParams:
    ...
    def __init__(
        ...
        Args:
            ...
            idle_release_timeout (Optional[int]): Idle release timeout in seconds. If set,
                the session will be released after being idle for this duration. Defaults to None.
        """
