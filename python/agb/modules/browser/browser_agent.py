...
class BrowserAgent(BaseService):
    ...
    async def _execute_act_async(
        ...
        while max_retries > 0:
            ...
            _async_caller = getattr(self, "_call_mcp_tool_async", None)
            if _async_caller is not None:
                result = await _async_caller(
    ...
    def extract(self, options: ExtractOptions, page=None) -> Tuple[bool, Optional[T]]:
        """
