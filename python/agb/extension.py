    ...
    **Context Management**:
    ...
    def __init__(self, agb: "AGB", context_id: str = ""):
        ...
        if not context_result.success or not context_result.context:
            raise AGBError(
                f"Failed to create extension repository context: {context_id}"
            )
    ...
    def _upload_to_cloud(self, local_path: str, remote_path: str):
        ...
        try:
            with open(local_path, "rb") as f:
                ...
                response = session.put(pre_signed_url, data=f, timeout=upload_timeout)
    ...
    def create_extension_option(self, extension_ids: List[str]) -> ExtensionOption:
        ...
        Example:
            ...
            ```
        """
        return ExtensionOption(context_id=self.context_id, extension_ids=extension_ids)
