...
- `session.screen.get_size()`
- `session.mouse.get_position()`
...
- `session.window.resize()`
- `session.window.fullscreen()`
- `session.window.focus_mode()`
- `session.mouse.click()`
- `session.mouse.move()`
- `session.mouse.drag()`
- `session.mouse.scroll()`
- `session.keyboard.type()`
- `session.keyboard.press()`
- `session.keyboard.release()`
