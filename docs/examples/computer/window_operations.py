            ...
            if start_result.success and len(start_result.data) > 0:
                ...
                if windows_result.success and len(windows_result.windows) > 0:
                    ...
                    for i, window in enumerate(windows_result.windows):
                        print(f"    Window {i+1}: ID={window.window_id}, Title='{window.title}'")
                    ...
                    print(f"  🎯 Selected window: ID={window_id}, Title='{window_title}'")
                    ...
                    if activate_result.success and activate_result.data:
                        ...
                        if active_window_result.success and active_window_result.window:
                            ...
                            if str(active_id) == str(window_id):
                                ...
                                print(f"  ⚠️  Active window mismatch: expected {window_id}, got {active_id}")
                        else:
                    ...
                    if minimize_result.success and minimize_result.data:
                        ...
                        print(f"  ❌ Window minimize failed: {minimize_result.error_message}")
                    ...
                    if maximize_result.success and maximize_result.data:
                        ...
                        print(f"  ❌ Window maximize failed: {maximize_result.error_message}")
                    ...
                    if restore_result.success and restore_result.data:
                        ...
                        print(f"  ❌ Window restore failed: {restore_result.error_message}")
                    
                    # Take screenshot after restore
                    take_and_save_screenshot(
                        session, 
                        "window restore", 
                        "window_restore_screenshot.png"
                    )
                    ...
                    resize_result = session.computer.resize_window(window_id, new_width, new_height)
                    if resize_result.success and resize_result.data:
                        print(f"  ✅ Window resized to {new_width}x{new_height} successfully")
                        time.sleep(2)
                    else:
                        print(f"  ❌ Window resize failed: {resize_result.error_message}")
                    # Take screenshot after resize
                    take_and_save_screenshot(
                        session, 
                        "window resize", 
                        "window_resize_screenshot.png"
                    )
                    ...
                    if fullscreen_result.success and fullscreen_result.data:
                        ...
                        print(f"  ❌ Fullscreen failed: {fullscreen_result.error_message}")
                    ...
                    if cursor_result.success:
                        ...
                        print(f"  ⚠️  Cursor position retrieval failed: {cursor_result.error_message}")
