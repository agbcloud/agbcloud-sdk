...
class TestCreateSessionParams(unittest.TestCase):
    ...
    def test_create_session_params_with_all_parameters_including_policy_id(self):
        ...
        self.assertEqual(len(params.context_syncs), 1)
        self.assertEqual(params.browser_context, browser_ctx)
        self.assertEqual(params.idle_release_timeout, 600)
    ...
    def test_create_session_params_with_idle_release_timeout(self):
        """Test CreateSessionParams with idle_release_timeout."""
        params = CreateSessionParams(idle_release_timeout=600)
