...
from agb.context_sync import ContextSync, ExtractPolicy, SyncPolicy, UploadPolicy, BWList, WhiteList
from agb.modules.browser.browser import BrowserOption
from agb.session_params import CreateSessionParams
from agb.extension import ExtensionsService, Extension
...
class TestExtensionBrowserIntegration(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Set up test environment with Agb client and create test extensions."""
        ...
        cls.extensions_service = ExtensionsService(cls.agb, cls.context_name)
        ...
        browser_context_result = cls.agb.context.get(cls.browser_context_name, create=True)
    ...
    def tearDownClass(cls):
        ...
        if hasattr(cls, "browser_data_context"):
            try:
                cls.agb.context.delete(cls.browser_data_context)
